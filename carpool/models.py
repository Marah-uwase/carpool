...
class Trip(models.Model):
    user = models.ForeignKey(CustomUser, null=False, blank=False, related_name='hosts', on_delete=models.CASCADE,)
...
class Request(models.Model):
    from_user = models.ForeignKey(CustomUser, null=False, blank=False, on_delete=models.CASCADE,)
